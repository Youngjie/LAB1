...
set rc [catch {
  ...
  open_checkpoint D:/study/embled/project_boss2/project_2/project_2.runs/impl_1/design_1_wrapper.dcp
...
set rc [catch {
  ...
  catch {update_ip_catalog -quiet -current_ip_cache {d:/study/embled/project_boss2/project_2/project_2.cache} }
  opt_design 
...
set rc [catch {
  ...
  if { [file exists D:/study/embled/project_boss2/project_2/project_2.runs/synth_1/design_1_wrapper.hwdef] } {
    catch { write_sysdef -hwdef D:/study/embled/project_boss2/project_2/project_2.runs/synth_1/design_1_wrapper.hwdef -bitfile design_1_wrapper.bit -meminfo design_1_wrapper_bd.bmm -file design_1_wrapper.sysdef }
  }
