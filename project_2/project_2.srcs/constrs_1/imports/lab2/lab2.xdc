...
set_property PACKAGE_PIN Y16 [get_ports {bstn_4bit_tri_i[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bstn_4bit_tri_i[3]}]
set_property PACKAGE_PIN V16 [get_ports {bstn_4bit_tri_i[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bstn_4bit_tri_i[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bstn_4bit_tri_i[1]}]
set_property PACKAGE_PIN P16 [get_ports {bstn_4bit_tri_i[1]}]
set_property PACKAGE_PIN R18 [get_ports {bstn_4bit_tri_i[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bstn_4bit_tri_i[0]}]
